...
import "./SubmitNewManuscript.css";
function SubmitNewManuscript() {
          ...
          <form onSubmit={handleSubmit} className="manuscript-form">
            ...
            <div className="form-group">
              <label htmlFor="authorName" className="form-label">
                Name of Author <span className="required">*</span>
              </label>
              <input
                type="text"
                id="authorName"
            ...
            <div className="form-group">
              <label htmlFor="affiliation" className="form-label">
                Affiliation (Institution) <span className="required">*</span>
              </label>
              <input
                type="text"
                id="affiliation"
              ...
              />
              {errors.affiliation && (
                <span className="error-message">{errors.affiliation}</span>
              )}
            </div>
